...
//Amacı; kullanıcı oturumunu yöneterek, giriş yapan kullanıcılar için tek seferlik bir API bağlantısı (client) kurmak, bunu refresh_token ile sürekli güncel ve geçerli tutmaktır.